							...
							<div class="side-content">
								<div class="menu-block-wrapper menu-block-ctools-main-menu-1 menu-name-main-menu parent-mlid-17090 menu-level-1">
									<ul class="side">
										...
										<li><b>MY서재</b></li>
										<li>-&nbsp;&nbsp;<a class="ml-2" href="${pageContext.request.contextPath}/loans/listLoansReservationForMember">대출예약현황</a></li>
										<li class="bg-dark">-&nbsp;&nbsp;<a class="ml-2 text-light" href="${pageContext.request.contextPath}/loans/listLoansForMember">도서대출현황</a></li>
								...
								<table class="table table-hover">
									<thead class="bg-dark text-light">
										...
										<tr>
											...
											<th class="text-center small align-middle">반납예정일</th>
									...
									<c:forEach items="${list}" var="loans">
										<tr>
											...
											<td class="text-center small align-middle">
												<c:if test="${loans.status == 6}"><i class="fas fa-circle text-danger"></i>&nbsp;&nbsp;<span class="text-danger">연체중</span></c:if>
											</td>
										</tr>
									</c:forEach>
									</tbody>
